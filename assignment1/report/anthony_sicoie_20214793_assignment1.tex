...
\subsection*{Code:}
\lstinputlisting[language=C, caption=\centering{OpenMP code for question 4}, label={q4:openmp}]{../q4/openmp.c}

\subsection*{Logs:}
\lstinputlisting[language=sh, caption=\centering{OpenMP output for question 4}, label={q4:openmplog}]{../q4/openmp.log}

\section*{Q5:}

\subsection*{Code:}
\lstinputlisting[language=C, caption=\centering{OpenMP code for question 5}, label={q5:openmp}]{../q5/openmp.c}

\subsection*{Logs:}
\lstinputlisting[language=sh, caption=\centering{OpenMP output for question 5}, label={q5:openmplog}]{../q5/openmp.log}

\section*{Q6:}

\subsection*{Code:}
\lstinputlisting[language=C, caption=\centering{OpenMP code for question 6}, label={q6:openmp}]{../q6/openmp.c}

\subsection*{Logs:}
\lstinputlisting[language=sh, caption=\centering{OpenMP output for question 6}, label={q6:openmplog}]{../q6/openmp.log}
